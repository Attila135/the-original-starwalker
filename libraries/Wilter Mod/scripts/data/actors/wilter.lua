local actor, super = Class(Actor, "wilter")
...
function actor:init()
    ...
    self.animations = {
        ...
        ["transform_1"] = {"transform/wilter_transform_one", 0.1, true},
        ["transform_2"] = {"transform/wilter_transform_two", 0.1, true},
        ["transform_3"] = {"transform/wilter_transform_three", 0.1, true},
    }
    ...
    self.offsets = {
        ...
        ["death/slmn5"] = {-2,0},
        ["death/dead"] = {-10, 0},
        ["transform/wilter_transform_one"] = {-44, -68},
        ["transform/wilter_transform_two"] = {-44, -68},
        ["transform/wilter_transform_three"] = {-44, -68},
