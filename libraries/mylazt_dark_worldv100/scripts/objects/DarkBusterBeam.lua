local DarkBusterBeam, super = Class(Sprite)

function DarkBusterBeam:init(red, x, y, tx, ty, after)
    super.init(self, red and "effects/dark_beam" or "effects/dark_beam", x, y)
...
function DarkBusterBeam:update()
    ...
    if self.afterimg_timer >= 1 then
        ...
        local sprite = Sprite(self.red and "effects/dark_beam" or "effects/dark_beam", self.x, self.y)
