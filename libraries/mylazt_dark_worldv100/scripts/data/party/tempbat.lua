local character, super = Class(PartyMember, "tempbat")
...
function character:init()
    ...
    self:setActor("tempbat")
    --self:setLightActor("noelle_lw")

    -- Display level (saved to the save file)
    self.level = Game.chapter
    -- Default title / class (saved to the save file)
    self.title = "Tempbat\nKeep those paws\nKeep those claws\nYour wagging tail\nWas always frail\n\nFrom beyond was the\nFrom beyond was the\nFrom beyond was the\nFrom beyond was the\nFrom beyond was the\nFrom beyond was the\nFrom beyond was the\nFrom beyond was the\nFrom beyond was the\nFrom beyond was the\nFrom beyond was the\nDriven by curiosity, you peered into the digital fossil. Thank you for remembering."

    -- Determines which character the soul comes from (higher number = higher priority)
    self.soul_priority = 1
    -- The color of this character's soul (optional, defaults to red)
    self.soul_color = {0.89, 0.64, 0.36}
