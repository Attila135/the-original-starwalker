local spell, super = Class(Spell, "curse_claw")

function spell:init()
    super.init(self)

    -- Display name
    self.name = "CURSE CLAW"
    ...
    self.effect = "DUST\nDAMAGE"
    -- Menu description
    self.description = "THE DUST SUFFOCATES ONE VICTIM." -- CURSE deals damage at the beginning of a turn
