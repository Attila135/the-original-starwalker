local raven_2, super = Class(Wave)
local angleChange = 1
local clawTimeVar = 0
local initialX = 0
local initialY = 0
...
-- function raven_2:onDamage(soul)
-- super.onDamage(self)
...
function raven_2:ClawMoveTo(posX, posY)
...
-- FIXER MULT BEGIN
    ...
    if (self.timeVar % 20 == 0) 
        ...
        if (self.ravenCount % 2 == 0 or self.ravenCount == 0)
            ...
            ravenDark = self.switchDirection % 2 == 0;
