local dustpawclaw_2, super = Class(Wave)
local angleChange = 1
local timeVar = 0
local initialX = 0
local initialY = 0
...
-- function dustpawclaw_2:onDamage(soul)
-- super.onDamage(self)
...
function dustpawclaw_2:onStart()
...
-- FIXER MULT BEGIN
    ...
    if (self.timeVar == 30 or self.timeVar == 48 or self.timeVar == 70 or self.timeVar == 88 or self.timeVar == 102 or self.timeVar == 140 or self.timeVar == 158 or self.timeVar == 180 or self.timeVar == 198 or self.timeVar == 210) 
    then 
    self.attackAmount = 12
    if (self.timeVar == 102 or self.timeVar == 210) then self.attackAmount = 15; self.willDark = false; end
        ...
        for i = 0, 20,1 
            ...
            for _, attacker in ipairs(attackers) do
                ...
                if (self.attackAmount > 0)
                    ...
                    if (self.attackAmount >= 13) then shouldDark = false; end
