local throw_4, super = Class(Wave)
local angleChange = 1
...
-- function throw_4:onDamage(soul)
-- super.onDamage(self)
...
function throw_4:ThrowMoveTo(posX, posY)
...
function throw_4:update()
    ...
    do
        ...
        if (self.hasMoved == false) then attacker.timer:tween(1, attacker, {x = attacker.x + 70.0}, 'out-quad') self.hasMoved = true; end
