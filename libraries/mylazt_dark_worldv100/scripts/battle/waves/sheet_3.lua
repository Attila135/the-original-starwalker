...
function sheet_2:update()
        ...
        if (attacker2.id == "maskaught")
            ...
            if (self.swordAmount > 0)
                ...
                if (self.loberaTimeVar == 20 or
                    ...
                    local bulletY = Game.battle.soul.y + self.swordSpawnY;
                    ...
                    self.swordSpawnY = math.sin(self.swordsSpawned / 0.14) * 18;
                ...
                if (attacker2.sprite.anim == "raise" and attacker2.sprite.frame == 1)
                 ...
                 if (attacker2.sprite.anim == "raise" and attacker2.sprite.frame == 3 and self.loberaReady == true)
                    then
    ...
    if (self.timeVar == 5)
        then
        self.clefSpawn1 = self:spawnBullet("clef", Game.battle.arena.x - 140, Game.battle.arena.y, 0, 0, 1, 1.0, 90.0, 0.4, 120.0, 155);
        self.clefSpawn2 = self:spawnBullet("clef", Game.battle.arena.x - 140, Game.battle.arena.y, 0, 0, 2, -0.5, 90.0, -0.4, 120.0, 60);
