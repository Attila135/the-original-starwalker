local raven_b, super = Class(Wave)
local angleChange = 1
local clawTimeVar = 0
local initialX = 0
local initialY = 0
...
-- function raven_b:onDamage(soul)
-- super.onDamage(self)
...
function raven_b:ClawMoveTo(posX, posY)
...
function raven_b:init()
super.init(self);
self:setArenaSize(200, 142)
end
function raven_b:onStart()
...
-- FIXER MULT BEGIN
    ...
    if (self.timeVar % 40 == 0) 
        ...
        if (self.ravenCount % 2 == 0 or self.ravenCount == 0)
            ...
            self:spawnBullet("raven", Game.battle.arena.x - 20, Game.battle.arena.y - 100, 0, -50, math.rad(90), ravenSpeed, ravenDelay, true);
            self:spawnBullet("raven", Game.battle.arena.x - 40, Game.battle.arena.y - 100, 0, -50, math.rad(90), ravenSpeed, ravenDelay, true);
            self:spawnBullet("raven", Game.battle.arena.x - 60, Game.battle.arena.y - 100, 0, -50, math.rad(90), ravenSpeed, ravenDelay, true);
            self:spawnBullet("raven", Game.battle.arena.x - 80, Game.battle.arena.y - 100, 0, -50, math.rad(90), ravenSpeed, ravenDelay, true);
            self:spawnBullet("raven", Game.battle.arena.x - 100, Game.battle.arena.y - 100, 0, -50, math.rad(90), ravenSpeed, ravenDelay, true);
            else
