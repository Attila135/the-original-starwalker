local raven_1, super = Class(Wave)
local angleChange = 1
local clawTimeVar = 0
local initialX = 0
local initialY = 0
...
-- function raven_1:onDamage(soul)
-- super.onDamage(self)
...
function raven_1:ClawMoveTo(posX, posY)
...
-- FIXER MULT BEGIN
    ...
    if (self.timeVar % 20 == 0) 
        ...
        if (self.ravenCount % 2 == 0 or self.ravenCount == 0)
            ...
            self:spawnBullet("raven", Game.battle.arena.x + 180, Game.battle.arena.y + 40, 50, 0, math.rad(180), ravenSpeed, ravenDelay, false);
            self:spawnBullet("raven", Game.battle.arena.x + 180, Game.battle.arena.y + 20, 50, 0, math.rad(180), ravenSpeed, ravenDelay, false);
