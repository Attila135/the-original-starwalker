...
function claw_3:ClawMoveTo(posX, posY)
...
-- FIXER MULT BEGIN
 self.timeVar = self.timeVar + 1;
    ...
    if (self.timeVar < 110)
        ...
        if (Utils.dist(attacker.x, attacker.y, self.desX, self.desY) < 10 or 1 == 1) 
