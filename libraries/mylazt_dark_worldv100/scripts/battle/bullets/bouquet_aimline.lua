local bouquet_aimline, super = Class(Bullet)

function bouquet_aimline:init(x, y, angleStart, angleSpeed, angleDistance, shootMoment)
    -- Last argument = sprite path
    super.init(self, x, y, "bullets/bouquet_aimline")
...
function bouquet_aimline:update()
    ...
    if (self:collidesWith(Game.battle.arena.collider))
        ...
        self.wave:spawnBullet("flower_fadeslow", self.x, self.y, Utils.angle(self.x, self.y, Game.battle.soul.x, Game.battle.soul.y), 10);
        self.wave:spawnBullet("flower_fadeslow", self.x, self.y, Utils.angle(self.x, self.y, Game.battle.soul.x, Game.battle.soul.y), 9);
        self.wave:spawnBullet("flower_fadeslow", self.x, self.y, Utils.angle(self.x, self.y, Game.battle.soul.x, Game.battle.soul.y), 8);
        self.wave:spawnBullet("flower_fadeslow", self.x, self.y, Utils.angle(self.x, self.y, Game.battle.soul.x, Game.battle.soul.y), 7);
        self.wave:spawnBullet("flower_fadeslow", self.x, self.y, Utils.angle(self.x, self.y, Game.battle.soul.x, Game.battle.soul.y), 6);
        self.wave:spawnBullet("flower_fadeslow", self.x, self.y, Utils.angle(self.x, self.y, Game.battle.soul.x, Game.battle.soul.y), 5);
